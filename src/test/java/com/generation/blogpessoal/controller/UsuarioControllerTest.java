...
public class UsuarioControllerTest {
	...
	public void naoDeveDuplicarUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Maria Silva", "maria_silva@email.com.br", "12345678", "-"));
	...
	public void deveAtualizarUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(0L,"Juliana Andy","juliana_andy@email.com.br","juliana123","-"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),"Juliana Andy Ramos","juliana_ramos@email.com.br","juliana123","-");
